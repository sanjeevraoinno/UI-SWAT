...
WebUI.waitForElementClickable(findTestObject('UI Swat Object Repository_Participant/Manage Organization Link'), 30)

WebUI.click(findTestObject('UI Swat Object Repository_Participant/Manage Organization Link'))

WebUI.scrollToElement(findTestObject('UI Swat Object Repository_Participant/Organization_Combo box'), 30)

WebUI.mouseOver(findTestObject('UI Swat Object Repository_Participant/Organization_Combo box'))

WebUI.waitForElementVisible(findTestObject('Organization/UI Swat Object Repository_Title/Title label'), 60)

WebUI.click(findTestObject('Organization/UI Swat Object Repository_Title/Title label'))
...
WebUI.sendKeys(findTestObject('Organization/UI Swat Object Repository_Title/Title_Name'), 'Title1')
